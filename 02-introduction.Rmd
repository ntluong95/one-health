...
If you still want to try, an alternative is creating a dictionary that contain all value of variables

```{python, message = FALSE, warning=FALSE}
from siuba import *   
sex_dict = {0 : "Female", 1 : "Male"}
lb_df1 = raw_df >> mutate(sex = _.apply(lambda x: sex_dict.get(x["sex"], "Unknown"), axis = 1))
print(lb_df1)
```
